...
def convert_to_realistic_portrait_sketch(image_path, add_watermark=True):
    ...
    try:
        ...
        max_dimension = 3000  # Higher resolution for professional-quality detail
        ...
        # Step 2: Improved portrait-specific grayscale conversion with enhanced skin tone emphasis
        if len(img.shape) == 3:
            ...
            alpha = 1.08  # Slightly increased contrast boost for clearer lines
            beta = -8     # Darker for deeper, richer pencil-like appearance
